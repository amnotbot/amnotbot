...
public class QuoteThread extends Thread
{
    ...
    public QuoteThread(BotConnection con, String chan, IRCUser user, String msg)
    {
        this.con = con;
        this.chan = chan;
        this.user = user;
    ...
    private void createNewQuote(String text)
    {
        ...
        query = "INSERT INTO quotes (nick, desc) VALUES (" + "'" +
                this.user.getNick() + "'" + ", " + "\"" + text + "\"" + ");";

        this.execQuery(query);

        String msg;
        if (this.db.changes() > 0) {
            msg = "Quote (" + this.db.last_insert_rowid() + ") successfully created!";
